...
- Robust handling of Message-Id, In-Reply-To, References, and SES-generated message IDs
...
- Recipients are limited to the original sender and participants already present on the thread
